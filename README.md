...
가입 없이 바로 둘러볼 수 있도록 데모용 계정을 열어 두었습니다.

| 이메일 | 비밀번호 |
|---|---|
| `test@naver.com` | `t1111111` |

로그인하면 샘플 여행(오사카 3박 4일)이 들어 있어 **일정 · 지도 · 예산 · 기록 · 회고** 화면을 바로 확인할 수 있습니다.
폰 브라우저로 접속해 *공유 → 홈 화면에 추가* 하면 PWA로 설치되어 GPS · 카메라 · 마이크까지 동작합니다.

> 공용 데모 계정이라 다른 사람이 만든 데이터가 함께 보일 수 있습니다.
