...
public class TrackingController {
    ...
    public LocationResponse recordLocation(@PathVariable Long tripId,
        ...
        return trackingService.recordLocation(tripId, req);
    }

    @GetMapping("/locations")
    public List<LocationResponse> listLocations(@PathVariable Long tripId) {
        return trackingService.listLocations(tripId);
    }
    ...
    public MoodResponse recordMood(@PathVariable Long tripId,
        ...
        return trackingService.recordMood(tripId, req);
    }

    @GetMapping("/moods")
    public List<MoodResponse> listMoods(@PathVariable Long tripId) {
        return trackingService.listMoods(tripId);
    }
    ...
    public ExpenseResponse recordExpense(@PathVariable Long tripId,
        ...
        return trackingService.recordExpense(tripId, req);
    }

    @GetMapping("/expenses")
    public List<ExpenseResponse> listExpenses(@PathVariable Long tripId) {
        return trackingService.listExpenses(tripId);
    }

    @GetMapping("/expenses/summary")
    public ExpenseSummary expenseSummary(@PathVariable Long tripId) {
        return trackingService.expenseSummary(tripId);
    }
}
